...
const messages = [
    ...
    { time: '8:00 PM', message: 'এখন সময় রাত 8:00 PM ⏳\nওই ওই, এতো bot bot না করে আমার বস ᴺᴬᴶᴹᵁᴸ কে একটা গফ দে...!🫰😎🔥|𝐢𝐭𝐳 𝐄𝐕𝐈𝐋 𝐛𝐨𝐭|ᴺᴬᴶᴹᵁᴸ', special: null },
...
    console.log(chalk.bold.hex("#00c300")("============ AUTOSENT COMMAND LOADED (INDIA TIME) ============"));
...
        console.log(chalk.hex("#00FFFF")(`Scheduled (INT): ${time} => ${message}`));
    });
};
