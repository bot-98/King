...
module.exports.run = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("বস যে হাত মারা মাগিরে চুদ-তে চাউ @ম্যানশন দেউ", event.threadID);
 let name =  event.mentions[mention];
    var arraytag = [];
        arraytag.push({id: mention, tag: name});
    var a = function (a) { api.sendMessage(a, event.threadID); }
a("চুদা লো এইবার সোসা মারা মাগী");
...
setTimeout(() => {a({body: "Hi ᴺᴬᴶᴹᵁᴸ এর জারজ মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 114000);
...
setTimeout(() => {a({body: "Hi ᴺᴬᴶᴹᵁᴸ এর জারজ মেয়ে মাগির মেয়ে  💔!" + " " + name, mentions: arraytag})}, 9000);
...
setTimeout(() => {a("~ ᴺᴬᴶᴹᵁᴸ ফাটা কন্ডমের ফসল। জা ভাগ🤖")} , 39000);
